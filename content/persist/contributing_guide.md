...
```shell
git clone https://github.com/statirjs/persist
```

2. build **@statirjs/persist** with [**rollup**](https://rollupjs.org/), it will create a CommonJS module-per-module build, a ES Modules build and a UMD build
